...
Ecco una breve descrizione di ciascuna sezione:
NAME: Il nome dell'istanza.
COMMENT: Un commento o una descrizione dell'istanza.
TYPE: Il tipo di problema. In questo caso, ACVRP indica un problema di routing dei veicoli con capacità e asimmetrico.
DIMENSION: Il numero di nodi nel problema, inclusi il deposito e i clienti.
EDGE_WEIGHT_TYPE: Il tipo di pesi sugli archi. EXPLICIT indica che tutti i pesi sono forniti esplicitamente.
EDGE_WEIGHT_FORMAT: Il formato dei pesi degli archi. FULL_MATRIX indica che i pesi sono forniti come una matrice completa.
DISPLAY_DATA_TYPE: Il tipo di dati di visualizzazione. NO_DISPLAY indica che non ci sono dati di visualizzazione.
CAPACITY: La capacità dei veicoli.
VEHICLES: Il numero di veicoli disponibili.
EDGE_WEIGHT_SECTION: Una matrice che rappresenta i pesi (o costi) tra ogni coppia di nodi.
DEMAND_SECTION: Una lista che rappresenta la domanda di ogni cliente.
DEPOT_SECTION: Il nodo che rappresenta il deposito.